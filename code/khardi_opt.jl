...
function check_feasibility(model)
    ...
    elseif (termination_status(model)==OPTIMAL::TerminationStatusCode)
        ...
        global h_star=value.(h)
        global hl_star=value.(hl)
        global ph_star=value.(ph)
...
println("checking headloss feasibility\n")
check_feasibility(wds_opt)
#throw(DomainError)
...
title_text="Optimal hydralic component allocation for Khardi Redesign scheme"
fname="khardi_ilp"
